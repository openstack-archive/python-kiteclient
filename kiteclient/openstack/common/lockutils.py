...
from kiteclient.openstack.common import fileutils
from kiteclient.openstack.common.gettextutils import _, _LE, _LI
from kiteclient.openstack.common import log as logging
...
util_opts = [
    ...
    cfg.StrOpt('lock_path',
               default=os.environ.get("KITECLIENT_LOCK_PATH"),
...
def main(argv):
    ...
    os.environ["KITECLIENT_LOCK_PATH"] = lock_dir
    try:
