...
from kiteclient.openstack.common import local
# NOTE(flaper87): Pls, remove when graduating this module
# from the incubator.
from kiteclient.openstack.common.strutils import mask_password  # noqa
    ...
    if CONF.publish_errors:
        try:
            handler = importutils.import_object(
                "kiteclient.openstack.common.log_handler.PublishErrorsHandler",
                logging.ERROR)
        except ImportError:
            handler = importutils.import_object(
